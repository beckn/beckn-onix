...
completeSetup() {
    ...
    "BPP")
        ...
        layer2_config
        install_package
        install_bpp_protocol_server $registry_url echo "Installing BAP..."$bpp_subscriber_id $bpp_subscriber_key_id $bpp_subscriber_url $webhook_url
        ;;
    "ALL")
        echo "Installing all the components..."
