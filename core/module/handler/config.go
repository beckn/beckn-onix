...
type PluginManager interface {
	...
	ManifestLoader(ctx context.Context, cache definition.Cache, metaRegistry definition.RegistryMetadataLookup, cfg *plugin.Config) (definition.ManifestLoader, error)
